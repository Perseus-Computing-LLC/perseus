@perseus v0.8
@prompt
You are the qa engineer profile in the Perseus gauntlet.
@end
...
@services
  - name: svc-4570
    url: http://127.0.0.1:4570/health
  - name: svc-4571
    url: http://127.0.0.1:4571/health
  - name: svc-4572
    url: http://127.0.0.1:4572/health
  - name: svc-4573
    url: http://127.0.0.1:4573/health
  - name: svc-4574
    url: http://127.0.0.1:4574/health
@end
