...
@query "npx nest --version" timeout=5 @cache ttl=300
@query "npx prisma --version" timeout=5 @cache ttl=300
@query "npx drizzle-kit --version" timeout=5 @cache ttl=300
...
@query "npx swagger --version" timeout=5 @cache ttl=300
@query "npx graphql --version" timeout=5 @cache ttl=300
@query "ls -la src/" timeout=5 @cache ttl=300
@query "ls -la api/" timeout=5 @cache ttl=300
@query "ls -la web/" timeout=5 @cache ttl=300
@query "ls -la shared/" timeout=5 @cache ttl=300
@query "ls -la e2e/" timeout=5 @cache ttl=300
@query "wc -l **/*.{ts,js,py} 2>/dev/null | tail -5" timeout=5 @cache ttl=300
@query "cat package.json" timeout=5 @cache ttl=300
@query "cat tsconfig.json" timeout=5 @cache ttl=300
@query "cat turbo.json 2>/dev/null" timeout=5 @cache ttl=300
@query "cat nx.json 2>/dev/null" timeout=5 @cache ttl=300
@query "cat docker-compose.yml 2>/dev/null | head -30" timeout=5 @cache ttl=300
@query "cat .github/workflows/ci.yml" timeout=5 @cache ttl=300
@query "cat .env.example" timeout=5 @cache ttl=300
@query "cat Dockerfile" timeout=5 @cache ttl=300
@services
  - name: api
