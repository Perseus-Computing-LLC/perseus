@perseus v0.8
@prompt
You are the data engineer profile in the Perseus gauntlet.
@end
...
@services
  ...
  - name: svc-4531
    url: http://127.0.0.1:4531/health
  - name: svc-4532
    url: http://127.0.0.1:4532/health
  - name: svc-4533
    url: http://127.0.0.1:4533/health
  - name: svc-4534
    url: http://127.0.0.1:4534/health
@end
