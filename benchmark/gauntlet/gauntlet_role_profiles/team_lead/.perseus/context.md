@perseus v0.8
@prompt
You are the team lead profile in the Perseus gauntlet.
@end
...
@services
  ...
  - name: svc-4601
    url: http://127.0.0.1:4601/health
  - name: svc-4602
    url: http://127.0.0.1:4602/health
  - name: svc-4603
    url: http://127.0.0.1:4603/health
  - name: svc-4604
    url: http://127.0.0.1:4604/health
@end
