...
@query "npx react-scripts --version" timeout=5 @cache ttl=86400
...
@query "npx chromatic --version" timeout=5 @cache ttl=86400
@query "npx storybook --version" timeout=5 @cache ttl=86400
...
@query "ls -la src/hooks/" timeout=5 @cache ttl=86400
@query "ls -la src/lib/" timeout=5 @cache ttl=86400
...
@query "cat next.config.js 2>/dev/null || cat vite.config.ts 2>/dev/null" timeout=5 @cache ttl=86400
...
@query "cat postcss.config.js 2>/dev/null" timeout=5 @cache ttl=86400
