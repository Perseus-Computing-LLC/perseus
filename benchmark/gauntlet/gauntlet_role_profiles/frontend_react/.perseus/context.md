@perseus v0.8
@prompt
You are the frontend react profile in the Perseus gauntlet.
@end
...
@services
  - name: svc-4660
    url: http://127.0.0.1:4660/health
  - name: svc-4661
    url: http://127.0.0.1:4661/health
  - name: svc-4662
    url: http://127.0.0.1:4662/health
  - name: svc-4663
    url: http://127.0.0.1:4663/health
  - name: svc-4664
    url: http://127.0.0.1:4664/health
@end
