@perseus v0.8
@prompt
You are the devtools profile in the Perseus gauntlet.
@end
...
@services
  - name: svc-4580
    url: http://127.0.0.1:4580/health
  - name: svc-4581
    url: http://127.0.0.1:4581/health
  - name: svc-4582
    url: http://127.0.0.1:4582/health
  - name: svc-4583
    url: http://127.0.0.1:4583/health
  - name: svc-4584
    url: http://127.0.0.1:4584/health
@end
