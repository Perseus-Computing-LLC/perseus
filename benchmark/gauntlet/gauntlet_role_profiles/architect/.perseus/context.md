@perseus v0.8
@prompt
You are the architect profile in the Perseus gauntlet.
@end
...
@services
  - name: svc-4610
    url: http://127.0.0.1:4610/health
  - name: svc-4611
    url: http://127.0.0.1:4611/health
  - name: svc-4612
    url: http://127.0.0.1:4612/health
  - name: svc-4613
    url: http://127.0.0.1:4613/health
  - name: svc-4614
    url: http://127.0.0.1:4614/health
@end
