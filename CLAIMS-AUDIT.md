...
- **Perseus Vault MCP surface** — canonical names are maintained in the Vault source; no fixed public tool count is advertised because the surface evolves. ✓
...
- 2026-06-12/13: earlier revisions had a methodology error (fork search omission) and
  cited 23 Perseus Vault tools / 120 MCTS analyzers. Superseded by the 2026-06-28 source-verified
  figures above.
