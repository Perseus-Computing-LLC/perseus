...
# ── Optional: API Keys ─────────────────────────────────────────────────────
# Uncomment and fill in your keys. These are inherited by engram-rs subprocess.
...
# ── Optional: Engram-rs ────────────────────────────────────────────────────
# Database path for engram-rs (default: engram.db in working directory)
# ENGRAM_DB_PATH=~/.perseus/engram/engram.db
ENVEOF
...
# Engram-rs memory backend (optional — uncomment when engram-rs is installed)
# engram:
#   enabled: true
#   transport: "stdio"
