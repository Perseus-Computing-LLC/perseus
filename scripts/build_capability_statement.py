...
def build_story():
    ...
    return [
        ...
        fact_table([
            ("QA", f"{qa['value']} mean · 1,213/1,500", "Three accepted LongMemEval-S frozen-default official-CoT runs: Perseus Vault scored 80.2%, 80.6%, and 81.8% (pooled 1,213/1,500). The matched full-context controls pooled 66.9%; the gold-session oracle pooled 90.8%. The separate evidence-structured 82.0% paired confirmation is not blended into this series. None of these figures is a customer outcome, production result, or Government authorization."),
            ("Retrieval", "99.8% recall@10", "Company-run session-level retrieval on the current-main 500-instance LongMemEval split. Hybrid recall@1 83.2%, recall@3 96.6%, recall@5 98.8%, and recall@10 99.8%, MRR 0.8949. No answer-quality control arm. Retrieval-only; not answer accuracy, model quality, customer performance, deployment evidence, or production validation."),
