  ...
  <div class="wrap hero-layout">
    ...
    <div class="hero-proof">
      ...
      <div class="stat-grid">
        ...
        <article class="stat-card"><strong>99.2%</strong><span>session recall@10</span><small>LongMemEval-S · retrieval only · 500 instances</small><a class="text-link" href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report.json" rel="noopener">Read the retrieval report ↗</a></article>
