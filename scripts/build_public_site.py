...
<section class="section"><div class="wrap source-register"><div><p class="kicker">Detailed reports</p><h2>Follow the evidence.</h2></div><div><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/qa_report_cot_frozen_default_series_20260828.json">LongMemEval-S series report ↗</a><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/temporal/gauntlet_report.json">Temporal reconstruction report ↗</a><a href="{MEMCONFLICT_REPORT}" rel="noopener">Full eight-provider MemConflict report ↗</a><a href="/benchmarks/context-bench/">Context-Bench pilot →</a></div></div></section>
