...
def header(current: str, cta_href: str = "/docs/", cta_label: str = "Start locally") -> str:
    ...
    mobile = "".join(f'<a href="{href}"{" rel=\"noopener\"" if href.startswith("http") else ""}>{label}</a>' for _, href, label in visible_nav)
...
<section class="section route-section" id="system">
  <div class="wrap">
    ...
    <div class="route-list">
      <a href="/context-engine/"><span>01 / now</span><h3>Context Engine</h3><p>Build one briefing from the sources you choose.</p><b>See Context Engine →</b></a>
      <a href="/vault/"><span>02 / later</span><h3>Vault</h3><p>Carry decisions and time-valid facts into the next task.</p><b>See Vault →</b></a>
      <a href="/ledger/"><span>03 / review</span><h3>Ledger</h3><p>Record supplied events and references for later review.</p><b>See Ledger →</b></a>
    </div>
  </div>
</section>
...
<section class="section evidence-section"><div class="wrap proof-layout"><div><p class="kicker">Open evidence</p><h2>See the result, then the method.</h2><p>MemConflict tests changing facts, planted contradictions, and conditional preferences across eight self-hosted configurations.</p><div class="actions"><a class="button button-secondary" href="/benchmarks/">All methods</a><a class="text-link" href="{MEMCONFLICT_REPORT}" rel="noopener">Full comparison ↗</a></div></div><div class="report-card"><span>MemConflict / tested Vault configuration</span><strong>0.555</strong><p>Macro score in the self-run replication.</p><p class="card-note"><b>18 wrong</b> across 3,750 questions; 1,378 were blank or abstaining (36.7%). Wrong and blank outcomes are counted separately.</p><a href="{MEMCONFLICT_REPORT}" rel="noopener">Read the eight-provider report ↗</a></div></div></section>
  ...
  <div class="wrap hero-layout">
    ...
    <div class="hero-proof">
      ...
      <div class="stat-grid">
        ...
        <article class="stat-card risk"><strong>18</strong><span>wrong answers / 3,750 questions</span><small>Tested Vault configuration · wrong answers counted separately from blank responses</small><a class="text-link" href="{MEMCONFLICT_REPORT}" rel="noopener">See the outcome table ↗</a></article>
