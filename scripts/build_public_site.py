...
PAGES = [
    ...
    ("benchmarks/index.html", dict(path="/benchmarks/", title="Perseus methods and evidence", description="See the headline Perseus measurements with their conditions, limitations, and linked source reports.", current="proof", body=BENCHMARKS, page_class="methods-page", cta_href=MEMCONFLICT_REPORT, cta_label="MemConflict ↗")),
