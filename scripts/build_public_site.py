  ...
  <div class="wrap hero-layout">
    ...
    <div class="hero-proof">
      ...
      <div class="stat-grid">
        ...
        <article class="stat-card wide"><strong>40 writes/s</strong><span>durable write throughput</span><small>Measured at 100K entities on named hardware · content-hashed scale report · not an SLA</small><a class="text-link" href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/scale/report.json" rel="noopener">Read the scale report ↗</a></article>
      </div>
...
BENCHMARKS_DETAIL = """
<section class="page-intro methods-intro"><div class="wrap intro-grid"><div><p class="kicker">Methods and evidence</p><h1>See what each number measures.</h1></div><p class="lead">The current LongMemEval result is a source-checked, fully offline, judge-free session-level retrieval measurement.</p></div></section>
<section class="section"><div class="wrap"><div class="method-head"><div><span>Current retrieval lane</span><h2>LongMemEval-S public split</h2></div><div class="method-result"><strong>83.2%</strong><span>hybrid recall@1</span></div></div><div class="method-grid"><dl><div><dt>Dataset</dt><dd>500 questions and 23,867 ingested sessions from the public `_s` split</dd></div><div><dt>Metric</dt><dd>Ranked evidence-session retrieval against `answer_session_ids`; no answerer or judge</dd></div><div><dt>Full result</dt><dd>Recall@3 96.6%, recall@5 98.8%, recall@10 99.8%, MRR 0.8949</dd></div></dl><div class="limitation"><b>Boundary</b><p>This is retrieval-only evidence. It is not end-to-end QA accuracy, customer validation, production validation, or a model-quality claim.</p><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report-currentmain-2026-08-16.json">Read the committed report ↗</a></div></div></div></section>
<section class="section results-limits"><div class="wrap"><div class="section-heading"><p class="kicker">Read before using</p><h2>Keep unlike tests separate.</h2></div><div class="limit-grid"><article><span>Not QA accuracy</span><p>The offline report does not generate or judge an answer.</p></article><article><span>Not a customer outcome</span><p>No customer, operational deployment, or Government authorization is represented.</p></article><article><span>Not a service-level promise</span><p>Results are tied to the committed binary, dataset, feature profile, and hardware.</p></article></div></div></section>
"""
...
<section class="section results-section"><div class="wrap"><div class="results-grid"><article class="result-card featured"><span>Retrieval / LongMemEval-S</span><strong>83.2%</strong><h2>hybrid recall@1</h2><p><b>83.2% recall@1</b> and 98.8% recall@5 on the public split.</p><small>500 public questions and 23,867 ingested sessions; offline, judge-free retrieval. Not end-to-end QA, customer performance, or production validation.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report-currentmain-2026-08-16.json">Read the series report ↗</a></article><article class="result-card risk"><span>Conflict handling / MemConflict</span><strong>18</strong><h2>wrong answers out of 3,750 questions</h2><p>In the tested Perseus Vault configuration.</p><small>1,378 / 3,750 blank or abstaining (36.7%); wrong counted separately. Self-run comparison, not operational validation.</small><a href="{MEMCONFLICT_REPORT}" rel="noopener">Read the full comparison ↗</a></article><article class="result-card"><span>Retrieval</span><strong>99.8%</strong><h2>session recall@10</h2><p>Company-run retrieval on the 500-instance LongMemEval split.</p><small>Retrieval only. No answer-quality control arm.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report-currentmain-2026-08-16.json">Read the retrieval report ↗</a></article><article class="result-card"><span>Efficiency / Token A/B</span><strong>52.63%</strong><h2>fewer full-request prompt tokens</h2><p>Naive full-file assembly versus the shipped-default render on a named repo corpus.</p><small>Cold cache, context + 14 prompts, five fixture documents. Content assembly only; not provider billing or dollar savings.</small><a href="https://github.com/Perseus-Computing-LLC/perseus/blob/main/benchmark/tokenab/report.json" rel="noopener">Read the token report ↗</a></article><article class="result-card"><span>Operations</span><strong>40 writes/s</strong><h2>durable write throughput</h2><p>content-hashed scale report at 100K entities on named hardware.</p><small>Throughput only. Not customer capacity, deployment performance, or an SLA.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/scale/report.json">Read the scale report ↗</a></article></div></div></section>
<p class="source-note">Deprecated answerer/judge experiments remain internal-only and are excluded from the current public metric.</p>
...
<section class="section"><div class="wrap source-register"><div><p class="kicker">Detailed reports</p><h2>Follow the evidence.</h2></div><div><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report-currentmain-2026-08-16.json">LongMemEval-S series report ↗</a><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/temporal/gauntlet_report.json">Temporal reconstruction report ↗</a><a href="{MEMCONFLICT_REPORT}" rel="noopener">Full eight-provider MemConflict report ↗</a></div></div></section>
