...
<section class="hero home-hero">
  <div class="wrap hero-layout">
    ...
    <div class="hero-proof">
      <div class="proof-header"><span>Evidence from current runs</span><small>Company-run measurements</small></div>
      <div class="stat-grid">
        <article class="stat-card"><strong>80.9%</strong><span>mean accuracy / 1,500 questions</span><small>LongMemEval-S · 3 company-run runs · 500 questions each</small></article>
        <article class="stat-card risk"><strong>18</strong><span>wrong answers out of 3,750 questions</span><small>MemConflict · 1,378 / 3,750 blank or abstaining (36.7%); wrong counted separately</small></article>
        <article class="stat-card wide"><strong>40 writes/s</strong><span>durable write throughput</span><small>Measured at 100K entities on named hardware · signed scale report · not an SLA</small></article>
      </div>
      <p class="stat-footnote">These are company-run measurements. They are not customer outcomes, production validation, or Government authorization.</p>
    </div>
  </div>
</section>
...
<section class="section evidence-section"><div class="wrap proof-layout"><div><p class="kicker">Open evidence</p><h2>See the result, then the method.</h2><p>MemConflict tests changing facts, planted contradictions, and conditional preferences across eight self-hosted configurations.</p><div class="actions"><a class="button button-secondary" href="/benchmarks/">All methods</a><a class="text-link" href="{MEMCONFLICT_REPORT}" rel="noopener">Full comparison ↗</a></div></div><div class="report-card"><span>MemConflict / tested Vault configuration</span><strong>0.555</strong><p>Macro score in the self-run replication.</p><p class="card-note"><b>18 wrong</b> across 3,750 questions, with 36.7% of questions blank or abstaining.</p><a href="{MEMCONFLICT_REPORT}" rel="noopener">Read the eight-provider report ↗</a></div></div></section>
...
<section class="hero government-hero">
  <div class="wrap hero-layout">
    ...
    <div class="hero-proof">
      ...
      <p class="stat-footnote">Measured results are not customer outcomes, production validation, or Government authorization.</p>
    </div>
  </div>
</section>
