...
NAV = [
    ...
    ("docs", "/docs/", "Docs"),
    ("demo", VAULT_DEMO, "Live Vault demo ↗"),
]
...
def header(current: str, cta_href: str = "/docs/", cta_label: str = "Start locally") -> str:
    ...
    mobile = "".join(f'<a href="{href}"{" rel=\"noopener\"" if href.startswith("http") else ""}>{label}</a>' for _, href, label in NAV)
...
<header class="site-header" data-site-nav>
  <div class="wrap nav-row">
    ...
    <div class="nav-actions">
      ...
      <a class="button button-primary nav-cta" href="{cta_href}"{cta_rel}>{cta_label}</a>
  ...
  <nav class="mobile-nav" id="mobile-navigation" data-mobile-menu aria-label="Mobile">{mobile}<a href="{cta_href}"{cta_rel}>{cta_label}</a></nav>
</header>"""
...
<section class="hero home-hero">
  <div class="wrap hero-layout">
    <div class="hero-copy">
      ...
      <div class="actions"><a class="button button-primary" href="{VAULT_DEMO}#try" rel="noopener">Try the Vault demo ↗</a><a class="button button-secondary" href="/government/">For DoD programs and primes</a></div>
      <p class="boundary-note"><strong>Local by default.</strong> You choose the model, data path, deployment, and permissions.</p>
    </div>
    <div class="hero-proof">
      <div class="proof-header"><span>What we can show now</span><small>Measured, not certified</small></div>
      <div class="stat-grid">
        <article class="stat-card"><strong>80.9%</strong><span>LongMemEval-S mean</span><small>3 accepted company-run runs · 500-question split</small></article>
        <article class="stat-card risk"><strong>18</strong><span>wrong answers</span><small>MemConflict · 3,750 questions · 36.7% blank or abstaining</small></article>
        <article class="stat-card wide"><strong>40/s</strong><span>durable writes</span><small>Signed scale report on named hardware · not a service-level guarantee</small></article>
      </div>
...
<section class="section audience-section">
  <div class="wrap"><div class="section-heading"><div><p class="kicker">Choose a path</p><h2>Start where you are.</h2></div><p>See the product, the evidence, or the bounded Government workshare.</p></div><div class="link-grid">
    ...
    <a href="{VAULT_DEMO}#try" rel="noopener"><span>For a hands-on look</span><h3>Run the Vault demo ↗</h3><p>Save a decision, find it later, and prepare a short summary.</p><b>Open the demo</b></a>
...
<section class="section evidence-section"><div class="wrap proof-layout"><div><p class="kicker">Open evidence</p><h2>See the result, then the method.</h2><p>MemConflict tests changing facts, planted contradictions, and conditional preferences across eight self-hosted configurations.</p><div class="actions"><a class="button button-secondary" href="/benchmarks/">All methods</a><a class="text-link" href="{MEMCONFLICT_REPORT}" rel="noopener">Full comparison ↗</a></div></div><div class="report-card"><span>MemConflict / tested Vault configuration</span><strong>0.555</strong><p>Macro score in the self-run replication.</p><p class="card-note"><b>18 wrong</b> across 3,750 questions, with 36.7% blank or abstaining.</p><a href="{MEMCONFLICT_REPORT}" rel="noopener">Read the eight-provider report ↗</a></div></div></section>
...
<section class="section results-section"><div class="wrap"><div class="results-grid"><article class="result-card featured"><span>Quality / LongMemEval-S</span><strong>80.9%</strong><h2>three-run mean</h2><p><b>1,213 / 1,500</b> correct on the 500-question split.</p><small>3 accepted company-run runs. No customer, production, independent-holdout, or cross-model claim.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/qa_report_cot_frozen_default_series_20260828.json">Read the series report ↗</a></article><article class="result-card risk"><span>Conflict handling / MemConflict</span><strong>18</strong><h2>wrong answers</h2><p>Across 3,750 questions in the tested Vault configuration.</p><small>36.7% blank or abstaining. Self-run comparison, not operational validation.</small><a href="{MEMCONFLICT_REPORT}" rel="noopener">Read the full comparison ↗</a></article><article class="result-card"><span>Retrieval</span><strong>99.2%</strong><h2>session recall@10</h2><p>Company-run retrieval on the 500-instance LongMemEval split.</p><small>Retrieval only. No answer-quality control arm.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/longmemeval/report.json">Read the signed report ↗</a></article><article class="result-card"><span>Operations</span><strong>40/s</strong><h2>durable writes</h2><p>Signed scale report at 100K entities on named hardware.</p><small>Throughput only. Not customer capacity, deployment performance, or an SLA.</small><a href="https://github.com/Perseus-Computing-LLC/perseus-vault/blob/main/benchmark/scale/report.json">Read the scale report ↗</a></article></div></div></section>
...
<section class="hero government-hero">
  <div class="wrap hero-layout">
    <div class="hero-copy">
      ...
      <div class="actions"><a class="button button-primary" href="{VAULT_DEMO}#try" rel="noopener">Run the Vault demo ↗</a><a class="button button-secondary" href="#evidence">See the evidence</a><a class="text-link" href="/government/assets/Perseus-Computing-LLC-Capability-Statement.pdf">Capability brief →</a></div>
      <p class="boundary-note"><strong>Our role is limited.</strong> The mission owner and qualified integrator retain system, safety, test, accreditation, and operational authority.</p>
    </div>
    <div class="hero-proof">
      <div class="proof-header"><span>At a glance</span><small>Company-run evidence</small></div>
      <div class="stat-grid">
        <article class="stat-card"><strong>80.9%</strong><span>LongMemEval-S mean</span><small>3 accepted runs · 500-question split</small></article>
        <article class="stat-card risk"><strong>18</strong><span>wrong answers</span><small>MemConflict · 3,750 questions · 36.7% blank or abstaining</small></article>
        <article class="stat-card wide"><strong>40/s</strong><span>durable writes</span><small>Signed scale report · named hardware · not an SLA</small></article>
      </div>
...
PAGES = [
    ...
    ("government/index.html", dict(path="/government/", title="Perseus for DoD programs and primes", description="See how Perseus can serve as a bounded local context, memory, and evidence component beside a mission system.", current="defense", body=GOVERNMENT, page_class="government-page", cta_href=f"{VAULT_DEMO}#try", cta_label="Run demo ↗", og_image="/assets/og/government.png")),
