...
**Mnēmē** — Narrative project memory. Automatically distills checkpoints and oracle logs into a rolling project narrative (`@memory`).
...
Current release: **v1.0.2** — all Phase 1–22 tasks complete. 573 tests passing.
