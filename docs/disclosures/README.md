# Perseus Technical Disclosures

Public technical disclosures describing Perseus's architecture. These documents serve as defensive publications — they create prior art that prevents others from patenting the same concepts.

## Disclosures

| # | Title | Tier | Status |
|---|---|---|---|
| 1 | [Resolve-Before-Context Pipeline](disclosure-1-resolve-before-context.md) | Core | Published 2026-05-19 |
| 2 | [Checkpoint-Correlated Implicit Reinforcement Signals](disclosure-2-checkpoint-reinforcement.md) | Core | Published 2026-05-19 |
| 3 | [Five-Site Trust Boundary Architecture](disclosure-3-trust-boundary-architecture.md) | Core | Published 2026-05-19 |
...
- [IP Portfolio Overview](../ip/README.md) — patent and trademark status
- [LICENSE](../../LICENSE) — MIT (no patent grant)
