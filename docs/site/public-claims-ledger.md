...
| 80.9% LongMemEval-S frozen-default series | Company-run accepted measurement | Public Vault series report; three 500-question runs; 80.2% / 80.6% / 81.8% for Vault, pooled 1,213/1,500 | State official-CoT prompt, pinned answerer and official judge, hybrid k=10, full-context and oracle controls, equal-weight mean, and claim boundary; no product/generalization claim | Keep as primary frozen-default series |
| 82.0% LongMemEval-S evidence-structured confirmation | Company-run internal measurement | `claims.json`; accepted 500-question paired confirmation; 410/500 candidate vs 416/500 control | State dataset, denominator, official-CoT prompt, matched control 83.2%, -1.2 points, preregistered success rule failed; no superiority/production claim; keep separate from the frozen-default series | Keep as separate experimental result |
| 99.8% recall@10 | Company-run current-main retrieval measurement | Signed Vault LongMemEval retrieval refresh; hybrid R@1 83.2%, R@3 96.6%, R@5 98.8%, R@10 99.8%, MRR 0.8949 | Retrieval-only, 500-instance split, 23,867 sessions, offline and judge-free; not answer accuracy; earlier 99.2% report remains historical | Keep on methods page |
...
| 52.63% token reduction | Company-run content-hashed A/B | `benchmark/tokenab/report.json` | State named corpus/commit, full-request definition, cold cache, and that it is content-assembly reduction rather than provider billing or universal cost saving | Selected homepage product signal and detailed Methods page |
