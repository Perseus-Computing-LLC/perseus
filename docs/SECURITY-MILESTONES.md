...
*Last reviewed: 2026-08-26. Owner: Security Lead (see [`vuln-response.md`](./vuln-response.md)).*
...
| M3 | **Before claiming signed releases or SLSA provenance** | Verify the exact public registry/release attestations and publish reproducible verification instructions. | ⬜ Open — PyPI trusted publishing is configured; this repository does not claim a separate code-signing artifact or SLSA provenance for 1.0.26. |
