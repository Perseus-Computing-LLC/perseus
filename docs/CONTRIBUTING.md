...
Perseus is built with AI collaborators (Rovo Dev, Codex, Claude Code) as first-class contributors. The `AGENTS.md` file orients any AI agent at session start. Key rules for AI contributors:
