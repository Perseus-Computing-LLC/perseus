...
Vault's own `mimir_autocohere(capture_text=...)` remains the durability barrier for Vault-internal compaction stages. This Perseus hook covers the orchestration boundary before the local narrative compaction flow.
