...
_PERSEUS_VERSION = "1.0.10"  # replaced at build time by scripts/build.py — see VERSION file for canonical value
...
def _generated_header(version: str, source_hint: str = ".perseus/context.md") -> str:
    ...
    return (
        f"> [!NOTE]\n"
        f"> This file is generated by [Perseus](https://github.com/Perseus-Computing-LLC/perseus) v{version} on {now}.\n"
...
_PERSEUS_VERSION = "1.0.10"  # injected by scripts/build.py at build time
